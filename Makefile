...
.PHONY: prettier
prettier:		## Prettier
	pnpm exec prettier --single-quote --check 'src/**/*.{js,jsx,json,css,less,md}' 'searchlib/**/*.{js,jsx}'

.PHONY: prettier-fix
prettier-fix:	## Fix prettier
	pnpm exec prettier --single-quote  --write 'src/**/*.{js,jsx,json,css,less,md}' 'searchlib/**/*.{js,jsx}'

.PHONY: lint
lint:			## ES Lint
	pnpm exec eslint --max-warnings=0 'src/**/*.{js,jsx}' 'searchlib/**/*.{js,jsx}'

.PHONY: lint-fix
lint-fix:		## Fix ES Lint
	pnpm exec eslint --fix 'src/**/*.{js,jsx}' 'searchlib/**/*.{js,jsx}'

.PHONY: lint-fix
lint-list-files:		## Fix ES Lint
	pnpm exec eslint --format ./eslint-custom-format.js 'src/**/*.{js,jsx}' 'searchlib/**/*.{js,jsx}'

.PHONY: i18n
i18n:			## i18n
	rm -rf build/messages
	NODE_ENV=development scripts/i18n.cjs --addon

pipeline {
  ...
  environment {
        ...
        NAMESPACE = "@eeacms"
        SONARQUBE_TAGS = "volto.eea.europa.eu,clms.land.copernicus.eu,demo-www.eea.europa.eu,prod-www.eea.europa.eu,water.europa.eu-marine,circularity.eea.europa.eu,www.eea.europa.eu-en"
        DEPENDENCIES = ""
        VOLTO = "alpha"
    }
